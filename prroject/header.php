...
<header class="header">
   <div class="header-1" >
      ...
      <div class="flex"><img src="images/icon.gif" alt="nnnn">
         ...
         onMouseOut="this.style.padding=' 0em'">plz login</a> | <a href="register.php"onMouseOver="this.style.padding='1em'"
         onMouseOut="this.style.padding=' 0em'">Register</a> </p> <div class="loader-container" >
    <img src="images/icon.gif" alt="nnnn">
</div>
      </div>
   </div>
   ...
   <div class="header-2">
      ...
      <div class="flex">
         <a href="home.php" class="logo">OUR BOOK</a>
